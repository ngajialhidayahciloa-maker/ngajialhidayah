...
import { Santri, Report } from './types';
...
export default function App() {
  ...
  const handleAddSantri = (name: string, className: string, pin: string, gender: 'L' | 'P' = 'L'): Santri => {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
      ...
      <footer className="bg-white border-t border-slate-200 mt-auto py-6 text-center text-slate-400 text-xs">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 Al-Hidayah Digital. Dibuat khusus untuk memudahkan Guru Ngaji di seluruh Indonesia.</p>
          <button
            type="button"
